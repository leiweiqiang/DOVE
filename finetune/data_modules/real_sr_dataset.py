...
from finetune.data_modules.degradation import RandomBlur, RandomResize, RandomNoise, RandomJPEGCompression, RandomVideoCompression, DegradationsWithShuffle
from finetune.data_modules.utils import read_video_frames, random_crop_frames, paired_random_crop_video
...
class RealSRDataset(Dataset):
    ...
    def __getitem__(self, index: int) -> Dict[str, Any]:
        ...
        # Merge edge maps with LQ if enabled (BEFORE normalization)
